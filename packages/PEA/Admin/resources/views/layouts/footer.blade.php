<footer class="card mt-10 mx-4 md:p-6 xl:p-8 md:flex-row md:items-center md:justify-between">
...
<p class="my-10 text-sm text-center text-gray-500">
    © 2019-2023 <a href="#" class="hover:underline" target="_blank">CXM</a>. All rights reserved.
</p>
