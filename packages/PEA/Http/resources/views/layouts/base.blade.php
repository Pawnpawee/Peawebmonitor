...
<body class="bg-gray-50 dark:bg-gray-800">
    ...
    <div class="flex pt-16 overflow-hidden bg-gray-50 dark:bg-gray-900">
        ...
        <div class="inset-0 z-30 hidden bg-gray-900/50 dark:bg-gray-900/90" id="sidebarBackdrop"></div>
    ...
    <script>
        $('.form-delete').on('click', function(e) {
            if (confirm(
                    'This action will delete the selected information, which may not be recoverable. Are you sure?'
                )) {
                return true;
            }
            e.preventDefault();
