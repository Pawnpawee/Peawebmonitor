<div class="container-search" >
  ...
  <form wire:submit.prevent="search" class="form-search"> 
      ...
      <input wire:model="params.searchName" type="text" name="searchName" id="searchName" class="input-form" placeholder="Feeder name">
      </div>
  ...
  <div class="p-2">
  <button wire:click="$dispatch('openModal', {component: 'add-feeder'})" type="button" class="action save">
