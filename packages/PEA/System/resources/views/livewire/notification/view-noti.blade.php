<div>
    <div class="bg-cyan-500 flex">
        <h1 class="text-2xl p-5">View Message Template <em class="text-white text-lg not-italic ml-2">Default</em> </h1>
    </div>
    ...
    <div class="mx-5">
        <div class="mt-3">
            ...
            <label for="code" class="text-base text-cyan-700 ml-5"> Code
                <input disabled="true" wire:model="code" type="text" name="code" id="code"
                    class="w-1/3 text-sm ml-3 p-1 bg-gray-50 border border-gray-300 text-gray-900 focus:ring-cyan-500 focus:border-cyan-600">
            </label>
        </div>
        ...
        <div class="mt-8">
            ...
            <select disabled="true" wire:model="state" id="state"
        ...
        <div class="my-5 flex">
            ...
            <div class="ml-3 flex items-center me-4 ">
                <input disabled="true" wire:model.live="type" id="sms" type="radio" value="sms"
                    name="type-group" class="w-4 h-4 text-cyan-600 bg-gray-100 border-gray-300 focus:ring-cyan-500">
                <label for="sms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">SMS</label>
            </div>
            <div class="flex items-center me-4">
                <input disabled="true" wire:model.live="type" id="email" type="radio" value="email"
                    name="type-group" class="w-4 h-4 text-cyan-600 bg-gray-100 border-gray-300 focus:ring-cyan-500">
        ...
        @if ($type == 'sms')
            <div class="mt-5 block">
                ...
                <textarea disabled="true" wire:model="sms" type="text"
        ...
        @elseif ($type == 'email')
            <div class="mt-5 block">
                ...
                <input disabled="true" type="text" wire:model="subject"
                    class="mt-2 w-full text-sm p-2 bg-gray-50 border border-gray-300 text-gray-900 focus:ring-cyan-500 focus:border-cyan-600">
            </div>
            ...
            <div class="my-5 block">
                ...
                <div wire:ignore x-data="myFunction()">
                    <textarea disabled="true" id="editor" wire:model="body" name="body"></textarea>
                </div>
