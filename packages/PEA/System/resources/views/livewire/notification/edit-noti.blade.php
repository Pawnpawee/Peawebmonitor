<div>
    <div class="bg-cyan-500 flex">
        <h1 class="text-2xl p-5">Edit Message Template <em class="text-white text-lg not-italic ml-2">Default</em> </h1>
    </div>
    ...
    <div class="mx-5">
        ...
        <div class="my-5 flex">
            ...
            <div class="ml-3 flex items-center me-4 ">
                <input wire:model.change="type" id="sms" type="radio" value="sms" name="type-group"
            ...
            <div class="flex items-center me-4">
                <input wire:model.change="type" id="email" type="radio" value="email" name="type-group"
                    class="w-4 h-4 text-cyan-600 bg-gray-100 border-gray-300 focus:ring-cyan-500">
        ...
        @elseif ($type == 'email')
            ...
            <div class="my-5 block">
                ...
                <div wire:ignore x-data="myFunction()">
                    <textarea id="editor" wire:model="newbody" name="newbody"></textarea>
                </div>
    ...
    <div class="bg-gray-200 w-full p-4">
        <div class="ms-auto">
            ...
            <button wire:click="save" type="button"
                class="mx-2 bg-blue-600 rounded-md px-4 py-3 text-white">Save</button>
        </div>
    </div>
            ...
            ClassicEditor
                ...
                .then(editor => {
                    ...
                    editor.model.document.on('change:data', () => {
                        @this.set('newbody', editor.getData());
                    });
