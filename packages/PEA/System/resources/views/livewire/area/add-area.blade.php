        ...
        <div class="relative p-1 w-full max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-5 md:p-5">
                    ...
                    <h3 class="text-md font-semibold text-gray-900 dark:text-white">Add New Area</h3>
                ...
                <div class="p-5 md:p-5">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input wire:model="name" type="text" name="name" id="name" class="input-form"
                        ...
                        <div class="col-span-1">
                            ...
                            <input wire:model="weight" type="number" min = "0" max="9999" name="weight" id="weight" class="input-form"
                                placeholder="Weight">
                            <div class="error-text">
                                @error('weight')
                                    {{ $message }}
