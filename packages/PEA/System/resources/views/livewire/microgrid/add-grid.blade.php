        ...
        <div class="relative p-1 w-full max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-5 md:p-5">
                    <h3 class="text-md font-semibold text-gray-900 dark:text-white">Add New Microgrid</h3>
                </div>
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-3">
                        ...
                        <div class="col-span-3">
                            ...
                            <textarea wire:model="description" id="description" rows="4"
                                class="textarea-form"
                                placeholder="Microgrid description here"></textarea>
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input wire:model="latitude" type="number" step="0.0001" name="latitude" id="latitude"
                                class="input-form" placeholder="00.0000">
                            <div class="error-text">
                                @error('latitude')
                                    {{ $message }}
                                @enderror
